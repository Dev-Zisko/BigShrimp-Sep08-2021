...
@section('content')
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 style="text-align: center; color: #007ED8 !important;" class="m-0 font-weight-bold text-primary">Crear Categoría</h6>
            </div>
            <div class="card-body">
                  ...
                  <div class="social-line">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <div class="input-group mb-3">
                            ...
                            <input id="name" name="name" type="text" class="form-control" placeholder="Nombre de la categoria..." value="{{ old('name') }}" required>
