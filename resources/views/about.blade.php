      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold">Sobre nosotros</h1>
            <p class="breadcrumb-custom"><a href="{{ route('el-gran-camaron') }}">Principal</a> <span class="mx-2">&gt;</span> <span>Sobre nosotros</span></p>
          </div>
        </div>
      </div>
    </div>  
